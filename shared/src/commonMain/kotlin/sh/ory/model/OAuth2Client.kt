 ...
 * @param clientId OAuth 2.0 Client ID  The ID is autogenerated and immutable.
...
data class OAuth2Client (
    ...
    @SerialName(value = "allowed_cors_origins") val allowedCorsOrigins: kotlin.Array<kotlin.String>? = null,

    @SerialName(value = "audience") val audience: kotlin.Array<kotlin.String>? = null,
    ...
    @SerialName(value = "grant_types") val grantTypes: kotlin.Array<kotlin.String>? = null,
    ...
    @SerialName(value = "jwks") val jwks: JsonObject? = null,
    ...
    @SerialName(value = "post_logout_redirect_uris") val postLogoutRedirectUris: kotlin.Array<kotlin.String>? = null,

    @SerialName(value = "redirect_uris") val redirectUris: kotlin.Array<kotlin.String>? = null,
    ...
    @SerialName(value = "request_uris") val requestUris: kotlin.Array<kotlin.String>? = null,

    @SerialName(value = "response_types") val responseTypes: kotlin.Array<kotlin.String>? = null,
    ...
    @SerialName(value = "token_endpoint_auth_method") val tokenEndpointAuthMethod: kotlin.String? = null,
