...
open class RelationshipApi : ApiClient {
     ...
     * @return void
     */
    open suspend fun patchRelationships(relationshipPatch: kotlin.Array<RelationshipPatch>? = null): HttpResponse<Unit> {

        val localVariableAuthNames = listOf<String>("oryAccessToken")

        val localVariableBody = PatchRelationshipsRequest(relationshipPatch?.asList() ?: arrayListOf())
