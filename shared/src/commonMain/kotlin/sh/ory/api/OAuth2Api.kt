...
open class OAuth2Api : ApiClient {
     ...
     * @return kotlin.Array<OAuth2Client>
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun listOAuth2Clients(pageSize: kotlin.Long? = 250L, pageToken: kotlin.String? = "1", clientName: kotlin.String? = null, owner: kotlin.String? = null): HttpResponse<kotlin.Array<OAuth2Client>> {
        ...
        return request(
            ...
            localVariableBody,
            localVariableAuthNames
        ).wrap<ListOAuth2ClientsResponse>().map { value.toTypedArray() }
    }
     ...
     * @return kotlin.Array<OAuth2ConsentSession>
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun listOAuth2ConsentSessions(subject: kotlin.String, pageSize: kotlin.Long? = 250L, pageToken: kotlin.String? = "1", loginSessionId: kotlin.String? = null): HttpResponse<kotlin.Array<OAuth2ConsentSession>> {
        ...
        return request(
            ...
            localVariableBody,
            localVariableAuthNames
        ).wrap<ListOAuth2ConsentSessionsResponse>().map { value.toTypedArray() }
    }
     ...
     * @return kotlin.Array<TrustedOAuth2JwtGrantIssuer>
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun listTrustedOAuth2JwtGrantIssuers(maxItems: kotlin.Long? = null, defaultItems: kotlin.Long? = null, issuer: kotlin.String? = null): HttpResponse<kotlin.Array<TrustedOAuth2JwtGrantIssuer>> {
        ...
        return request(
            ...
            localVariableBody,
            localVariableAuthNames
        ).wrap<ListTrustedOAuth2JwtGrantIssuersResponse>().map { value.toTypedArray() }
    }
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun patchOAuth2Client(id: kotlin.String, jsonPatch: kotlin.Array<JsonPatch>): HttpResponse<OAuth2Client> {

        val localVariableAuthNames = listOf<String>("oryAccessToken")

        val localVariableBody = PatchOAuth2ClientRequest(jsonPatch.asList())
