...
enum class RegistrationFlowState(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: RegistrationFlowState?): kotlin.String? = if (data is RegistrationFlowState) "$data" else null

        /**
         * Returns a valid [RegistrationFlowState] for [data], null otherwise.
         */
        fun decode(data: RegistrationFlowState?): RegistrationFlowState? = data?.let {
