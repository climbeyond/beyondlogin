...
import org.openapitools.client.models.AuthenticatorAssuranceLevel
import org.openapitools.client.models.OAuth2LoginRequest
import org.openapitools.client.models.UiContainer
...
data class LoginFlow (
    ...
    @SerialName(value = "issued_at") @Required val issuedAt: kotlin.time.Instant,
    ...
    @SerialName(value = "state") @Required val state: JsonElement?,
    ...
    @SerialName(value = "created_at") val createdAt: kotlin.time.Instant? = null,
    ...
    @SerialName(value = "transient_payload") val transientPayload: JsonElement? = null,

    /* UpdatedAt is a helper struct field for gobuffalo.pop. */
    @SerialName(value = "updated_at") val updatedAt: kotlin.time.Instant? = null
     ...
     * The active login method  If set contains the login method used. If the flow is new, it is unset. password CredentialsTypePassword oidc CredentialsTypeOIDC totp CredentialsTypeTOTP lookup_secret CredentialsTypeLookup webauthn CredentialsTypeWebAuthn code CredentialsTypeCodeAuth passkey CredentialsTypePasskey profile CredentialsTypeProfile saml CredentialsTypeSAML link_recovery CredentialsTypeRecoveryLink  CredentialsTypeRecoveryLink is a special credential type linked to the link strategy (recovery flow).  It is not used within the credentials object itself. code_recovery CredentialsTypeRecoveryCode
     *
     * Values: password,oidc,totp,lookup_secret,webauthn,code,passkey,profile,saml,link_recovery,code_recovery
     */
    @Serializable
    enum class Active(val value: kotlin.String) {
        ...
        @SerialName(value = "saml") saml("saml"),
