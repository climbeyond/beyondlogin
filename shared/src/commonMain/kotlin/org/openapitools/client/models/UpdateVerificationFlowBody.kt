...
import org.openapitools.client.models.UpdateVerificationFlowWithCodeMethod
import org.openapitools.client.models.UpdateVerificationFlowWithLinkMethod
...
sealed class UpdateVerificationFlowBody {
    ...
    @SerialName(value = "method") @Required abstract val method: UpdateVerificationFlowBody.Method
    /* Sending the anti-csrf token is only required for browser login flows. */
    @SerialName(value = "csrf_token") abstract val csrfToken: kotlin.String?
    /* Transient data to pass along to any webhooks */
    @SerialName(value = "transient_payload") abstract val transientPayload: kotlin.String?
    ...
    @SerialName(value = "code") abstract val code: kotlin.String?
    /**
     * Method is the method that should be used for this verification flow  Allowed values are `link` and `code`. link VerificationStrategyLink code VerificationStrategyCode
     *
     * Values: link,code
