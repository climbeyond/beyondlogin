...
enum class AuthenticatorAssuranceLevel(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: AuthenticatorAssuranceLevel?): kotlin.String? = if (data is AuthenticatorAssuranceLevel) "$data" else null

        /**
         * Returns a valid [AuthenticatorAssuranceLevel] for [data], null otherwise.
         */
        fun decode(data: AuthenticatorAssuranceLevel?): AuthenticatorAssuranceLevel? = data?.let {
